...
if (isset($_GET['concurso'])) {
    ...
    for ($j = 0; $j < count($concursosD); $j++) {
        if ($concursosD[$j]->getId() === $concurso->getId()) {
            ...
            if (!in_array($idConcurso, $participantes)) {
    ...
    echo "<thead>" . "<th> ".'<span id="btnDec">▼</span> <span id="btnAsc">▲</span> '."MODOS</th>" .
     "<th>".'<span id="btnDec">▼</span> <span id="btnAsc">▲</span> '."BANDAS</th>" . "</thead>";
    # Tbody
    echo "<tbody>";
